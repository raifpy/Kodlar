//Bu dil en çok Java'ya benziyor . Değişkenler olarak Python'a , fonksiyonlar olarak da C'ye . Ama en çok Java'ya
...
void main(List args){
  ...
  var degiskenvar = "Merhaba Ben de String değişken ! Ama var ile tanımlandığım için veri tipim , ilk atama ile sabit kalmak şartı ile değişebilir ";
  dynamic degiskendynamic = "Merhaba Ben Dynamic ! . Şuan da String'im ama veri türüm istenilen zaman  istenildiği gibi değiştirilebilir [Python gibi]";

  var listeEleman = [degiskenstring,degiskenvar,degiskendynamic]; // manuel list
  List listeAmaBos = new List(10); // 10 null 'lu bir liste yaptık .
  List<String> listeAmaSadeceString = new List(10); // 10 elemanlı , sadece String alabilen liste yaptık
  ...
  for(String i in listeEleman){ // for-each
    print("for-each : "+i);
  }
  ...
  print("Olmayan çağırılıypr : ");print(benMapim["yokki"]);
  ...
  switch (abc){
    ...
    case "raifp":
      ...
      break;
    default:
      print("Olamaz hiç biri değil");break;
  }
  ...
  try{
    ...
    print("Olamaz , program çöktü :( Neyseki catch ile çökmesi engellendi o ye");
  }
